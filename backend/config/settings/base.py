...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "shamah_db"),
        "USER": os.environ.get("POSTGRES_USER", "shamah_user"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "shamah_password"),
...
# JWT Settings (Example - adjust as needed)
